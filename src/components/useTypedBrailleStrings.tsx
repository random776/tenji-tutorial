...
function toCodePoint(keyboardState: KeyboardState): number {
  if (keyboardState.Backspace) {
    ...
    if (keyboardState.KeyA) codePoint += 2 ** 6;
    if (keyboardState.KeyH) codePoint += 2 ** 3;
    if (keyboardState.KeyJ) codePoint += 2 ** 4;
    if (keyboardState.KeyK) codePoint += 2 ** 5;
    if (keyboardState.KeyL) codePoint += 2 ** 7;
    return codePoint;
  }
}
